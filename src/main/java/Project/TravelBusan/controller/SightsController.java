...
public class SightsController {
    ...
    @GetMapping("/{sights-id}/search-blog")
    public ResponseDto<List<BlogDetailResponseDto>> blogSearch(@PathVariable("sights-id") Long sightsId){
        return sightsService.searchBlog(sightsId);
    }
}
